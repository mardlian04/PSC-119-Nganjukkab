                    ...
                    <form method="POST" action="{{ route('galleries.store') }}" enctype="multipart/form-data"
                        ...
                        <div class="relative group">
                            ...
                            <input type="text" name="judul_file" required
                                ...
                                placeholder="Contoh: Dokumentasi Simulasi Bencana">
                        </div>
                                ...
                                <label
                                    ...
                                    <div class="flex flex-col items-center justify-center pt-5 pb-6">
                                        ...
                                        <p
                                            ...
                                            Klik untuk unggah</p>
                                        <p class="text-[10px] text-gray-400 uppercase tracking-tighter">JPG, PNG, atau
                                            PDF (Max 5MB)</p>
                                    </div>
                                    <input id="dropzone-file" type="file" name="path_file" class="hidden"
