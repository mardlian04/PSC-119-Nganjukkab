<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center gap-4">
            ...
            <div>
                <h2 class="text-2xl font-extrabold text-gray-800 tracking-tight">Edit Foto Galeri</h2>
                <p class="text-[10px] text-gray-400 uppercase tracking-[0.2em] font-bold">Perbarui informasi foto yang
                    telah diunggah</p>
            </div>
        </div>
    </x-slot>
            ...
            <div class="bg-white rounded-lg shadow-2xl shadow-gray-200/40 overflow-hidden border border-gray-50">
                ...
                <div class="bg-gradient-to-r from-[#B32121] to-[#8E1A1A] px-10 py-6 flex justify-between items-center">
                    <div class="flex items-center gap-3">
                        ...
                        <span class="text-white font-bold text-sm tracking-wide">Formulir Edit Foto</span>
                    </div>
                </div>
                ...
                <div class="p-10 md:p-14">
                    <form method="POST" action="{{ route('gallery.update', $gallery->id) }}"
                        ...
                        <div class="relative group">
                            ...
                            <input type="text" name="deskripsi" value="{{ $gallery->deskripsi }}"
                        ...
                        <div class="relative group">
                            <label
                                class="absolute -top-3 left-4 bg-white px-2 text-xs font-bold text-gray-400 uppercase tracking-wider z-10">Gambar
                                Saat Ini</label>
                            <div class="flex justify-center">
                                <img src="{{ asset('storage/' . $gallery->gambar) }}"
                                    class="rounded-2xl max-h-48 shadow-md">
                            </div>
                        </div>

                        <div class="relative group">
                            <label
                                class="absolute -top-3 left-4 bg-white px-2 text-xs font-bold text-gray-400 uppercase tracking-wider z-10">Ganti
                                Gambar</label>
                                ...
                                <label
                                    ...
                                    <div class="flex flex-col items-center justify-center pt-5 pb-6">
                                        ...
                                        <p
                                            ...
                                            Klik untuk unggah gambar baru</p>
                            ...
                            <p id="file-name-preview" class="mt-2 text-center text-xs font-bold text-[#B32121] hidden">
                                <i class="fa-solid fa-check-circle mr-1"></i> File baru: <span
